//https://www.e-olymp.com/ru/problems/119
#include <bits/stdc++.h>
using namespace std;
...
void solve()
{
    ...
    {
        ans++;
        da_umnogh_small(a, num2);
        string strA = da_str(a);
        if(strA == s.substr(0, strA.length()))
            s = s.substr(strA.length());
        else
        {
            ans--;
            break;
