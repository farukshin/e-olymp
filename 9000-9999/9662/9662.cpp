//https://www.e-olymp.com/ru/problems/9662
#include <bits/stdc++.h>
using namespace std;
...
void solve()
{
    ...
    cout << list.getOldestTeacher().toString() << "\n"
         << list.getOldestTeacher("Physics").toString() << "\n"
         << list.getYoungestTeacher().toString() << "\n"
         << list.getYoungestTeacher("Math").toString();
