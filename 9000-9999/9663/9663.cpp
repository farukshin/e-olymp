//https://www.e-olymp.com/ru/problems/9663
#include <bits/stdc++.h>
using namespace std;
...
void solve()
{
    ...
    cout << list.getTeachersBudget() << "\n"
         << list.getTeachersBudget("Math") << "\n"
         << list.getTeachersAverageSalary() << "\n"
         << list.getTeachersAverageSalary("Physics");
